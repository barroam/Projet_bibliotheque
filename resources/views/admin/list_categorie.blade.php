            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr >
                        ...
                        <td>
                            <a href="/modifie_C/{{ $categorie->id }}"  class="btn btn-custom btn-sm m-1" title="Modifier"><i class="fas fa-edit"></i></button>
                                <a href="/supprime_C/{{ $categorie->id }}"class="btn btn-custom btn-sm m-1" title="Supprimer"><i class="fas fa-trash-alt"></i></button>
                        </td>
                    </tr>
                    @endforeach
