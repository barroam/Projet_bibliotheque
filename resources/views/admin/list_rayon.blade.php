            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr >
                        ...
                        <td>{{$rayon->partie}}</td>
                        <td>
                            <a href="/modifie_R/{{$rayon->id}}" class="btn btn-custom btn-sm m-1" title="Modifier"><i class="fas fa-edit"></i></button>
                            <a href="/supprime_R/{{$rayon->id}}"class="btn btn-custom btn-sm m-1" title="Supprimer"><i class="fas fa-trash-alt"></i></button>
                        </td>
                    </tr>
                    @endforeach
