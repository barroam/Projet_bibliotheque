...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center" style="margin-top: 5rem">Modifier Catégorie</h1>
        <div class="card p-4">
            <form action="/modifie_sauvegarde_c/{{$categorie->id}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="libelle" id="libelle" value="{{$categorie->libelle}}" required>
                </div>
                <div class="form-group">
                    <label for="description">Description</label>
                    <input type="text" class="form-control" name="description" id="description" value="{{$categorie->description}}" required>
                </div>
